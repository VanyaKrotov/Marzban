...
from app.db.models.usages import NodeUserUsage
from app.db.models.users import NextPlan, User, UserUsageResetLogs
            ...
            if not dbuser.data_limit or dbuser.used_traffic < dbuser.data_limit:
                ...
                for percent in sorted(runtime_settings.notify_reached_usage_percent, reverse=True):
                    if not dbuser.data_limit or (calculate_usage_percent(
                        ...
                        reminder = notification_crud.get_notification_reminder(
                            db, dbuser.id, ReminderType.data_usage, threshold=percent)
                        if reminder:
                            notification_crud.delete_notification_reminder(db, reminder)
