...
```bash
git clone https://github.com/VanyaKrotov/Marzban.git
cd Marzban
...
安装最新版 Marzban 命令：
```bash
sudo bash -c "$(curl -fsSL https://raw.githubusercontent.com/VanyaKrotov/Marzban/master/scripts/marzban.sh)" @ install-script
```
